...
const formSchema = new mongoose.Schema({
  ...
  admissionFor: { type: String },

  particularsOfChild: {
      fullName: { type: String },
      surname: { type: String },
      nameUsedAtHome: { type: String },
  ...
  particularsOfParents: {
    ...
    FatherOrganisationName: { type: String },
    FatherSTDCodeRes: { type: String, default: "" },
    FatherTelRes: { type: String, default: "" },
    FatherSTDCodeOff: { type: String, default: "" },
    FatherTelOff: { type: String, default: "" },
    FatherMobile: { type: String },
    FatherEmail: { type: String },
    MotherName: { type: String },
    MotherQualification: { type: String },
    MotherOccupation: { type: String },
    MotherOrganisationName: { type: String },
    MotherSTDCodeRes: { type: String, default: "" },
    MotherTelRes: { type: String, default: "" },
    MotherSTDCodeOff: { type: String, default: "" },
    MotherTelOff: { type: String, default: "" },
  ...
  childPersonalBackground: {
    ...
    Siblings: {
      Brothers: [
        { name: { type: String, default: "" }, age: { type: String, default: "" } },
        { name: { type: String, default: "" }, age: { type: String, default: "" } },
        { name: { type: String, default: "" }, age: { type: String, default: "" } },
      ],
      Sisters: [
    ...
    PreviousKalamKidsDetails: { type: String, default: "" },
    PreviousKalamKids: { type: String, default: "" },
    suffered: { type: String, default: "" },
    surgery: { type: String, default: "" },
    allergy: { type: String, default: "" },
    phobias: { type: String, default: "" },
    phobiasDetails: { type: String, default: "" },
    medication: { type: String, default: "" },
    medicationDetails: { type: String, default: "" },
  },

  medicalRecord: {
    BCG: { type: String, default: "" },
    "DPT (I, II, III)": { type: String, default: "" },
    "Oral Polio vaccine (OPV)": { type: String, default: "" },
    Measles: { type: String, default: "" },
    MMR: { type: String, default: "" },
    DT: { type: String, default: "" },
    "HBV-Hepatitis (I, II, III)": { type: String, default: "" },
    "Hi B (Meningitis-3 doses)": { type: String, default: "" },
    Chickenpox: { type: String, default: "" },
    Typhoid: { type: String, default: "" },
    "Hepatitis A (2 doses)": { type: String, default: "" },
  },
  ...
  Declarationparent: {
    ...
    acknowledgmentSignatureRef: { type: String, default: "" }, // base64 image
